	...
	<body>
		<div id='header' style='margin-top: 30px; margin-left: auto; margin-right: auto; width: 900px; height: 100px;'>
			<div style='float: left; width: 50%'>
				<font size='5' color='blue'> UTS Mathematics </font><br/>
				<font size='9' onClick="document.location.href='/src/php/pages/tag_question.php?username=<?= $_SESSION['username']?>'" style='cursor:pointer;'> Math Connect </font> 
			</div>
