		...
		Toolbar : 
		{
			...
			Commands :
			{
				...
				viewSource : 
				{
					...
					func : function(sender, highlighter)
					{
						var code = dp.sh.Utils.fixForBlogger(highlighter.originalCode).replace(/</g, '&lt;').replace(/>/g, '&gt;');
						var wnd = window.open('', '_blank', 'width=750, height=430, location=0, resizable=1, menubar=0, scrollbars=0');
						wnd.document.write('<html><head><title>Source view</title></head><body><textarea style="width:99%;height:400px">' + code + '</textarea></body></html>');
						wnd.document.close();
					}
				},
...
dp.sh.Highlighter = function()
{
	 ...
	 */
	this.spaceWidth = dp.sh.Utils.measureSpace() || 6;
};
