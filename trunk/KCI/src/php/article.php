<?php
require_once ('D:\workSpace_Zend\KCI\src\php\dataModels\Reference.php');
require_once ('D:\workSpace_Zend\KCI\src\php\dataModels\Tag.php');
require_once ('D:\workSpace_Zend\KCI\src\php\dataModels\Citation.php');
...
<html>
	...
	<script type='text/javascript'>
		...
		function addCitation(currentUri) {
			...
			$('<img>').attr({onClick:"removeCitation('" + uriModified +"')", src:"http://localhost/KCI/resources/images/cross.png", id:uriModified}).addClass("delete_button").appendTo(div);
...
//			//Request the search.php page and get the search resault
			...
			$.get('http://localhost/KCI/src/php/search.php', { isAjax:'true', function:'createReference', id: uriModified },
				function(htmlResult){
		...
		$(document).ready(function() {
			...
			$('#search_button').click(function(){
				...
				//Request the search.php page and get the search resault
				$.get('http://localhost/KCI/src/php/search.php', { isAjax:'true', function:'search', searchItem: textField },
					function(htmlResult){
		...
		<div id='page_dvi'>
			...
			<div class='section' id='section1'>
				<textarea class='section_text' rows='10' cols='80' id='textArea1'>
					This is the first textArea.
					Just shows 2 rows and 20 columns.
				</textarea>
			...
			<div>
				...
				<textarea class='tag' rows='5' cols='80' id='tag_textArea'>
					This is tag area.
					Just shows 5 rows and 80 columns.
				</textarea>
			</div>
