...
<head>
	...
	<script type="text/javascript">
		function startRun(){
			...
			window.location.href = 'http://dalite.oise.utoronto.ca:9999/login?destination=http://dalite.oise.utoronto.ca/src/php/ajaxServices/securityCheck.php?runId='+runId; 
		}
	</script>
</head>
			...
			<tr>
				<td class='logo'>
					<form action="/src/php/ajaxServices/securityCheck.php" method="post">
						...
						<a href="http://dalite.oise.utoronto.ca:9999/login?destination=http://dalite.oise.utoronto.ca/src/php/ajaxServices/securityCheck.php">I'm a teacher</a>
					</form>
				</td>
